...
from authentication.forms import UserLoginForm, UserPasswordResetForm, UserSetPasswordForm
...
urlpatterns = [
    ...
    path('password_reset_confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='authentication/password_reset_confirm.html', form_class = UserSetPasswordForm), name='password_reset_confirm'),
